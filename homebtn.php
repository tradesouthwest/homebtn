...
{    
    wp_register_style( 'homebtn-public', HOMEBTN_URL . 'lib/homebtn-public.css' );
    //let WP handle ver and loading
    wp_enqueue_style(  'homebtn-public' );
    
    wp_register_script( 'homebtn-transition', plugin_dir_url(__FILE__)
                         . 'lib/homebtn-transition.js', 
                         array( 'jquery' ), 
                         '', 
                         true); 
    wp_enqueue_script( 'homebtn-transition');
}
